...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _loadRememberedEmail() async {
    ...
    if (rememberedEmail != null) {
      setState(() {
        ...
        _rememberedEmail = rememberedEmail;  // Store the original remembered email
        _rememberMe = true;
      });
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Always save remembered email if remember me is checked
      if (_rememberMe) {
      ...
      if (mounted) {
        ...
        } else if (e is UnverifiedEmailError) {
                        ...
                        Checkbox(
                          ...
                          onChanged: (value) async {
                            ...
                            if (!_rememberMe) {
                              ...
                              _rememberedEmail = null;  // Clear the stored remembered email
                            }
                          },
